...
def _build_mask_1d(inputs, mask, kernel_size, strides, padding, dilation = 1):
...
class MaskedMaxPooling1D(keras.layers.MaxPooling1D):
    def compute_mask(self, inputs, mask = None):
        return _build_mask_1d(inputs, mask, self.pool_size[0], self.strides[0], self.padding)
