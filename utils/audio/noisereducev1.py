# This file is an up-to-date version of the `noisereducev1.py` file from the `noisereduce` library
...
def _stft(y, n_fft, hop_length, win_length, use_tensorflow=False):
    if use_tensorflow:
        ...
        return _stft_librosa(y, n_fft, hop_length, win_length)
...
def _istft(y, n_fft, hop_length, win_length, use_tensorflow=False):
    if use_tensorflow:
        ...
        return _istft_librosa(y, hop_length, win_length)
